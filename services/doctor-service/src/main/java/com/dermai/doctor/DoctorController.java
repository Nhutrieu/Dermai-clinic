...
public class DoctorController{
 private final DoctorRepository doctors;private final ScheduleRepository schedules;private final LeaveRepository leaves;
 DoctorController(DoctorRepository d,ScheduleRepository s,LeaveRepository l){doctors=d;schedules=s;leaves=l;}
