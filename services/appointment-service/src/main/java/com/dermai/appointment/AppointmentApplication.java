...
@SpringBootApplication @EnableScheduling public class AppointmentApplication{public static void main(String[] a){SpringApplication.run(AppointmentApplication.class,a);}}
