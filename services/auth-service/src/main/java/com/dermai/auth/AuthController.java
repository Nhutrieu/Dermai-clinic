...
public class AuthController {
 private final AuthService service;private final String bootstrapToken;private final String serviceToken;
 public AuthController(AuthService service,@Value("${security.bootstrap-token}") String token,@Value("${security.service-token}") String serviceToken){this.service=service;this.bootstrapToken=token;this.serviceToken=serviceToken;}
